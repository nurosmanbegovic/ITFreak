...
id_sefa number(10) NULL REFERENCES UPOSLENICI(id_lica)
);
...
id_stavke number(10) NOT NULL REFERENCES STAVKA_FAKTURE(id_stavke),
datum_od date NOT NULL,
datum_do date NULL
);

DROP TABLE PRAVNALICA_UGOVORI;

ALTER TABLE UGOVORI ADD (id_lica number(10) NOT NULL REFERENCES PRAVNA_LICA(id_lica));

ALTER TABLE KOLICINA_U_SKLADISTIMA ADD (id number(10) NOT NULL PRIMARY KEY);

ALTER TABLE ISPORUKA ADD (datum_isporuke date NOT NULL);
